 ...
 *  ```
 *  bin/magento line:verified-purchase:notify-pending 1905
 *  ```
 */
class PendingCommand extends Command
{
    protected const COMMAND_NAME = 'line:verified-purchase:notify-pending';
    ...
    {
        $description = 'Sends a "Pending" notification email to the given Order Id';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        try {
            ...
            $result = $this->notification->notifyPending($verification);
